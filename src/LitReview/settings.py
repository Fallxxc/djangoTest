...
SECRET_KEY = '@bz3k+fq9#^juohz$em9yv+drf4vhnth$7fy*q8)8wy!_!+$&1'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'UserFollows.context_processors.profile_pic',
                'UserFollows.context_processors.invatations_received_no',
            ],
        },
    },
]
